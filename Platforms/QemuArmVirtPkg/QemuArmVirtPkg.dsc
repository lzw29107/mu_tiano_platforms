...
!include NetworkPkg/NetworkLibs.dsc.inc
  ...
  FdtHelperLib|QemuArmVirtPkg/Library/FdtHelperLib/FdtHelperLib.inf
  OemMiscLib|QemuArmVirtPkg/Library/OemMiscLib/OemMiscLib.inf
...
[LibraryClasses.common.PEIM]
  ...
  PeiServicesTablePointerLib|ArmPkg/Library/PeiServicesTablePointerLib/PeiServicesTablePointerLib.inf
  ArmVirtMemInfoLib|QemuArmVirtPkg/Library/QemuVirtMemInfoLib/QemuVirtMemInfoPeiLib.inf
...
!endif
  ...
  gQemuArmVirtPkgTokenSpaceGuid.PcdPciExpressBarSize|0x10000000
  gQemuArmVirtPkgTokenSpaceGuid.PcdPciExpressBarLimit|0xFFFFFFFF
...
!include NetworkPkg/NetworkPcds.dsc.inc
  ...
  gQemuArmVirtPkgTokenSpaceGuid.PcdPlatformAhciBase|0x60100000
  gQemuArmVirtPkgTokenSpaceGuid.PcdPlatformAhciSize|0x00010000
...
[PcdsFixedAtBuild.ARM]
  ...
  # if the entry point version is >= 3.0. ARM OSes cannot assume the
  # presence of the 32-bit entry point anyway (because many ARM systems
...
[PcdsDynamicDefault.common]
  ...
  gQemuArmVirtPkgTokenSpaceGuid.PcdSystemManufacturer|L"Palindrome"
  gQemuArmVirtPkgTokenSpaceGuid.PcdSystemSerialNumber|L"42-42-42-42"
  gQemuArmVirtPkgTokenSpaceGuid.PcdSystemSKU|L"NorthAmerica"
  gQemuArmVirtPkgTokenSpaceGuid.PcdSystemFamily|L"ArmMax"

  gQemuArmVirtPkgTokenSpaceGuid.PcdBaseBoardAssetTag|L"ProjectMu"
  gQemuArmVirtPkgTokenSpaceGuid.PcdBaseBoardSerialNumber|L"42-42-42-42"
  gQemuArmVirtPkgTokenSpaceGuid.PcdBaseBoardSKU|L"NorthAmerica"
  gQemuArmVirtPkgTokenSpaceGuid.PcdBaseBoardLocation|L"Internal"

  gQemuArmVirtPkgTokenSpaceGuid.PcdChassisSerialNumber|L"42-42-42-42"
  gQemuArmVirtPkgTokenSpaceGuid.PcdChassisVersion|L"1.0"
  gQemuArmVirtPkgTokenSpaceGuid.PcdChassisManufacturer|L"Palindrome"
  gQemuArmVirtPkgTokenSpaceGuid.PcdChassisAssetTag|L"ProjectMu"
  gQemuArmVirtPkgTokenSpaceGuid.PcdChassisSKU|L"NorthAmerica"
...
!endif
  ...
  QemuArmVirtPkg/ConfigKnobs/ConfigKnobs.inf
...
!endif
  ...
  QemuArmVirtPkg/QemuVideoDxe/QemuVideoDxe.inf
...
!endif
  ...
  QemuArmVirtPkg/QemuArmVirtPlatformDxe/QemuArmVirtPlatformDxe.inf
...
[BuildOptions]
  ...
  MSFT:*_*_ARM_GENFW_FLAGS  = --keepexceptiontable
  GCC:*_*_ARM_GENFW_FLAGS   = --keepexceptiontable
...
[BuildOptions.common.EDKII.DXE_RUNTIME_DRIVER]
  GCC:*_GCC5_ARM_DLINK_FLAGS = -z common-page-size=0x10000
  GCC:*_CLANGPDB_ARM_DLINK_FLAGS = /ALIGN:0x10000
  RVCT:*_*_ARM_DLINK_FLAGS = --scatter $(EDK_TOOLS_PATH)/Scripts/Rvct-Align4K.sct

[BuildOptions.ARM.EDKII.MM_CORE_STANDALONE,BuildOptions.ARM.EDKII.MM_STANDALONE]
